...
System.register(["lodash", "../../../core/utils/flatten", "../../../core/time_series2", "../../../core/table_model", "angular"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    function transformDataToTable(data, panel) {
        var model = new table_model_1.default(), copyData = angular_1.default.copy(data);
        ...
        if (panel.filterNull) {
            for (var i = 0; i < copyData.length; i++) {
                copyData[i].datapoints = copyData[i].datapoints.filter(function (dp) { return dp[0] != null; });
            }
        }
    ...
    var lodash_1, flatten_1, time_series2_1, table_model_1, angular_1, transformers;
    return {
        setters: [
            function (lodash_1_1) {
                lodash_1 = lodash_1_1;
